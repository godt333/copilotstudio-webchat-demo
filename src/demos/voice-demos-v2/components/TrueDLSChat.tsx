...
export const TrueDLSChat: React.FC = () => {
  ...
  // The DLS channel is blocked by Azure policy in this tenant, and calling
  // createDirectLineSpeechAdapters can crash Chrome's renderer process
  // (STATUS_BREAKPOINT). The user must click the "Connect" button manually.
        ...
        <div className="chat-main-area">
          <div className="webchat-wrapper">
            ...
            {connectionStatus === 'idle' && (
              <div className="loading-container enhanced" style={{ textAlign: 'center' }}>
                <h3 style={{ marginBottom: 8 }}>⚡ Direct Line Speech</h3>
                <p style={{ color: '#605e5c', maxWidth: 500, margin: '0 auto 16px' }}>
                  DLS uses a single WebSocket for both conversation and speech.
                  <br />
                  <strong style={{ color: '#a4262c' }}>Note:</strong> The DLS channel is currently blocked by Azure policy in this tenant.
                  Clicking Connect may cause the browser tab to crash.
                </p>
                <button
            ...
            {(connectionStatus === 'fetching-token' || (connectionStatus === 'connecting' && !adapters)) && renderLoading()}
