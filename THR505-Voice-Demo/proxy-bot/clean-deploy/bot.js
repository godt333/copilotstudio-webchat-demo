...
exports.ProxyBot = void 0;
const botbuilder_1 = require("botbuilder");
/**
 * ProxyBot - Forwards messages between DLS and Copilot Studio
 */
class ProxyBot extends botbuilder_1.ActivityHandler {
    constructor(copilotClient, conversationState, userState) {
        super();
        this.copilotClient = copilotClient;
        this.conversationState = conversationState;
        this.userState = userState;
        // Create state property accessor for session data
        this.sessionAccessor = this.conversationState.createProperty('sessionData');
    ...
    async handleMessage(context) {
        ...
        try {
            ...
            const copilotResponses = await this.copilotClient.sendMessage(userId, userText, sessionData.locale);
